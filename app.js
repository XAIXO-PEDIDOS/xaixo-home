...
function selectScene(index,focus=false){
 ...
 scenePanel.setAttribute('aria-label',`Ambiente de ${['cocina','baño','salón','exterior','vivienda completa'][current]}; desliza para cambiar de espacio`);
...
document.querySelectorAll('[data-space]').forEach(a=>a.addEventListener('click',()=>selectScene(Number(a.dataset.space))));
